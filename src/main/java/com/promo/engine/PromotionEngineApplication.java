...
public class PromotionEngineApplication {
    public static void main(String[] args) {
        ...
        HashMap<Character, Integer> cartItems = cartService.getCartItems();
        ...
        HashMap<Character, ActivePromotionsItems> activePromotions =promotionService.getActivePromotions();
